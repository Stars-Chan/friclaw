...
本文介绍如何使用企业微信**智能助手（长连接模式）**接入 FriClaw。
...
2. 侧边栏点击 **工作台**，搜索 **智能机器人**，点击 **创建机器人**
   <br/><img src="./images/wework-0.png" width="600" alt="Streaming" />
3. 选择 **手动创建**
   <br/><img src="./images/wework-1.png" width="600" alt="Streaming" />

4. 拉到最低，选择 **API 模式创建**
   <br/><img src="./images/wework-2.png" width="600" alt="Streaming" />
5. 选择 **长连接方式**，创建完成后，会显示：

- **Bot ID**: 类似 `xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx`
- **Secret**: 类似 `xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx`
  <br/><img src="./images/wework-3.png" width="600" alt="Streaming" />

---

## 配置 FriClaw

编辑 `~/.friclaw/config.json`:
...
1. 在企业微信中找到"FriClaw"机器人
2. 发送消息：**你好**
3. 收到 AI 回复

### 群聊

1. 将 FriClaw 机器人添加到群聊
2. **@机器人** 发送消息
3. 收到 AI 回复
